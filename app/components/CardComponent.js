...
const CardComponent = ({item, index}) => {
  return (
    <View
    key={index} 
      style={styles.colorbodyContainer}>
      <View style={styles.rowText}>
        <View
          ...
          <Text style={styles.nameTxtStyle}>{item.AccountName}</Text>
        ...
        <View style={styles.borderWidthCtn}>
              ...
              <View style={styles.widthConatiner}>
                <View style={styles.textContainer}>
                  <Text style={styles.keyTextValues}>{'Account Code'}</Text>
                  <Text style={styles.valuesTextStyle}>{item.AccountCode}</Text>
                </View>
                <View style={styles.textContainer}>
                  <Text style={styles.keyTextValues}>{'StartUp Equity'}</Text>
                  <Text style={styles.valuesTextStyle}>{item.StartUpEquity}</Text>
                </View>
                <View style={styles.textContainer}>
                  <Text style={styles.keyTextValues}>{'Debit'}</Text>
                  <Text style={styles.valuesTextStyle}>{item.DebitAmount}</Text>
                </View>
                <View style={styles.textContainer}>
                  <Text style={styles.keyTextValues}>{'Credit'}</Text>
                  <Text style={styles.valuesTextStyle}>{item.CreditAmount}</Text>
                </View>
